LangString addOrReinstall ${LANG_SIMPCHINESE} "添加或重装组件"
...
LangString appRunning ${LANG_SIMPCHINESE} "{{product_name}} 正在运行！请先关闭它，再重试。"
...
LangString dontUninstallDowngrade ${LANG_SIMPCHINESE} "不卸载（此安装器禁用不卸载直接降级）"
LangString failedToKillApp ${LANG_SIMPCHINESE} "无法结束 {{product_name}}。请先关闭它，再重试。"
LangString installingWebview2 ${LANG_SIMPCHINESE} "正在安装 WebView2..."
LangString newerVersionInstalled ${LANG_SIMPCHINESE} "系统中已安装更新版本的 ${PRODUCTNAME}！不建议安装旧版本。如果你确实要安装旧版本，建议先卸载当前版本。请选择要执行的操作，然后点击“下一步”继续。"
LangString older ${LANG_SIMPCHINESE} "旧"
LangString olderOrUnknownVersionInstalled ${LANG_SIMPCHINESE} "系统中已安装 $R4版本的 ${PRODUCTNAME}。建议先卸载当前版本，再继续安装。请选择要执行的操作，然后点击“下一步”继续。"
LangString silentDowngrades ${LANG_SIMPCHINESE} "此安装器禁用静默降级，无法继续静默安装。请改用图形界面安装程序。$\n"
...
LangString webview2InstallError ${LANG_SIMPCHINESE} "错误：安装 WebView2 失败，退出码为 $1"
